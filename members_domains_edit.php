...
$sql_modify = mysql_query("SELECT * FROM " . $prefix . "_members_domains WHERE domain_id ='$domain_id' ");
$data_modify = mysql_fetch_array($sql_modify);
$domain_name = stripcslashes($data_modify['domain_name']);
$domain_register_date = stripcslashes($data_modify['domain_register_date']);
$domain_expire_date = stripcslashes($data_modify['domain_expire_date']);
$domain_noties = stripcslashes($data_modify['domain_noties']);
$create_date = stripcslashes($data_modify['create_date']);
$domain_price = stripcslashes($data_modify['domain_price']);
...
?>
    ...
    <div class="modelTitle">
        <h4><i class="fa fa-edit"></i> <?php echo $lang_var_admin_458; ?> </h4>
    </div>
    <br>

    <form
        action="members.php?id=<?php echo $member_id; ?>&act=update&domain_id=<?php echo $domain_id; ?>&domainact=save<?php echo $sve_in; ?>"
        method="post"
        ...
        $domain_register_date = $pd_current_date;
        $domain_expire_date = date('Y-m-d', strtotime('+1 year'));
        $domain_expire_date = date('Y-m-d', strtotime("-1 day", strtotime($domain_expire_date)));
        ?>
        <div class="modelTitle">
            <h4><i class="fa fa-edit"></i> <?php echo $lang_var_admin_459; ?> </h4>
        </div>
    <br>
        <form
            action="members.php?id=<?php echo $member_id; ?>&act=update&domainact=insert<?php echo $sve_in; ?>"
            method="post"
            class="form-horizontal" enctype="multipart/form-data">
            <?php
            }
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3"><?php echo $lang_var_admin_453; ?> <span
                            class="required">*</span></label>

                    <div class="col-md-8">
                        <input type="text" name="domain_name" required="" value="<?php echo $domain_name; ?>"
                               class="form-control"/>
                    </div>
                </div>
                    ...
                    <div class="col-md-8">
                        <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control"
                                   value="<?php echo $domain_register_date; ?>" name="domain_register_date" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control"
                                   value="<?php echo $domain_expire_date; ?>" name="domain_expire_date" readonly>
				<span class="input-group-btn">
				<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
				</span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="domain_price" required="" value="<?php echo $domain_price; ?>"
                               class="form-control"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea name="domain_noties" rows="5"
                                  class="form-control"><?php echo $domain_noties; ?></textarea>
                    </div>
                </div>
                <?php
                if ($stat == "update") {
