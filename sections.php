...
//-------
$section_title_en = mysql_real_escape_string(@$_POST['section_title_en']);
$section_title_ar = mysql_real_escape_string(@$_POST['section_title_ar']);
$father_id = mysql_real_escape_string(@$_POST['father_id']);
$section_icon = mysql_real_escape_string(@$_POST['section_icon']);
...
if ($wm_section != "" && $wm_section != 0 && is_numeric($wm_section)) {
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="page-title"><?php echo $lang_var_admin_85 . " " . $ws_title_var; ?></h3>
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="#"><?php echo $lang_var_admin_85 . " " . $ws_title_var; ?></a>
                            </li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if ($clicked_btn == "b_saveorder") {
                            $sql_delete_who = mysql_query("SELECT * FROM " . $prefix . "_sections where wm_section_id='$wm_section'");
                            while ($data_delete_who = @mysql_fetch_array($sql_delete_who)) {
                                $inm = "row_no" . "$data_delete_who[section_id]";
                                $row_no = @$_POST[$inm];
                                $sql_sveorder = mysql_query("UPDATE " . $prefix . "_sections SET row_no='$row_no' WHERE section_id='$data_delete_who[section_id]'") or die (mysql_error());
                                if ($sql_sveorder) {
                                    $actin_done = 1;
                                }
                            }
                        ...
                        if ($multichkbx != "") {
                            ...
                            if ($clicked_btn == "b_active") {
                                $sql_active = mysql_query("UPDATE " . $prefix .
                                    "_sections SET section_status=1 WHERE section_id in ($multichkbx)") or die(mysql_error
                                ());
                                if ($sql_active) {
                                    $actin_done = 1;
                                }
                                ...
                                $sql_block = mysql_query("UPDATE " . $prefix .
                                    "_sections SET section_status=0 WHERE section_id in ($multichkbx)") or die(mysql_error
                                ());
                                if ($sql_block) {
                                    $actin_done = 1;
                                }
                                ...
                                $sql_delete_who = mysql_query("SELECT * FROM " . $prefix .
                                    "_sections where section_id  in ($multichkbx)");
                                while ($data_delete_who = @mysql_fetch_array($sql_delete_who)) {
                                    if ($data_delete_who['section_icon'] != "") {
                                        @unlink("$up_dir" . "$data_delete_who[section_icon]");
                                    }
                                }
                        ...
                        if ($act == "insert" && ($section_title_en != "" || $section_title_ar != "")) {
                                ...
                                if (!in_array($ext, $allowed_imgs_type)) {
                                    ...
                                    if ($tmp_file_width > 0 && $tmp_file_height > 0) {
                                        if (move_uploaded_file($file_temp_name, $file_name)) {
                                            $section_icon = $xrand . $ext;
                                        }
                                    }
                                }
                            }

                            $r = "select max(row_no)  from " . $prefix . "_sections where father_id='$father_id' and wm_section_id='$wm_section'";
                            $sqlr = mysql_query($r);
                            $rr = mysql_fetch_array($sqlr);
                            $row = $rr[0] + 1;

                            $sql_slct_max = mysql_query("select max(section_id)  from " . $prefix .
                                "_sections");
                            $data_slct_max = mysql_fetch_array($sql_slct_max);
                            $next_section_id = $data_slct_max[0] + 1;
							if($father_id==""){$father_id = 0;}
                            $sql_insert_new = mysql_query("INSERT INTO " . $prefix . "_sections (
  section_id,
  section_title_ar,
  section_title_en,
  father_id,
  ...
  edit_from,
  wm_section_id,
  row_no) VALUES ('$next_section_id','$section_title_ar','$section_title_en','$father_id','$section_icon','1','$pd_admin_user_id',now(),'$pd_admin_ip','$wm_section','$row')");

                            if ($sql_insert_new) {

                                // insert notification
                                $note_title_ar = ($lang_var_admin_384 . " " . $section_title_ar);
                                $note_title_en = ($lang_var_admin_383 . " " . $section_title_en);
                                $note_icon = mysql_real_escape_string("<div class='label label-sm label-success'>
                            <i class='fa fa-sitemap'></i>
                        </div>");
                                $note_url = mysql_real_escape_string("sections.php?wm_section=$wm_section&id=$next_section_id&act=update");
                        ...
                        if ($act == "saveupdate" && ($section_title_en != "" || $section_title_ar != "") && $id != "") {

                            // --- upload
                            if ($file_del == 1) {
                                @unlink("$up_dir" . "$section_icon");
                                $section_icon = "";
                            }
                            if ($file_name != "") {
                                if ($section_icon != "") {
                            ...
                            $sql_update = mysql_query("UPDATE " . $prefix . "_sections SET section_title_ar='$section_title_ar',section_title_en='$section_title_en',father_id='$father_id',section_icon='$section_icon',edit_by='$pd_admin_user_id',edit_date=now(),edit_from='$pd_admin_ip' WHERE section_id='$id'") or
                            die(mysql_error());
                            ...
                            if ($sql_update) {
                                ...
                                // insert notification
                                $note_title_ar = ($lang_var_admin_385 . " " . $section_title_ar);
                                $note_title_en = ($lang_var_admin_386 . " " . $section_title_en);
                                $note_icon = mysql_real_escape_string("<div class='label label-sm label-info'>
                            <i class='fa fa-pencil'></i>
                        </div>");
                                $note_url = mysql_real_escape_string("sections.php?wm_section=$wm_section&id=$id&act=update");
                        ...
                        if ($act == "update") {
                            $sql_modify = mysql_query("SELECT * FROM " . $prefix .
                                "_sections  WHERE section_id ='$id' ");
                            $data_modify = mysql_fetch_array($sql_modify);
                            $section_title_ar = stripcslashes($data_modify['section_title_ar']);
                            $section_title_en = stripcslashes($data_modify['section_title_en']);
                            $father_id = stripcslashes($data_modify['father_id']);
                            $section_icon = stripcslashes($data_modify['section_icon']);
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form
                                        action="?wm_section=<?php echo $wm_section; ?>&id=<?php echo $id; ?>&act=saveupdate"
                                        method="post"
                                        class="form-horizontal" enctype="multipart/form-data">
                                        <div class="form-body">

                                            <?php if ($ws_sections_st == 2) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control" name="father_id" class="select2me">
                                                            ...
                                                            <?php
                                                            $sql_father_retrive = mysql_query("SELECT * FROM " . $prefix . "_sections where wm_section_id='$wm_section' and father_id='0' and section_id !='$id' order by row_no, section_id");
                                                            while ($data_father_retrive = mysql_fetch_array($sql_father_retrive)) {
                                                                ...
                                                                ?>
                                                                <option
                                                                    value="<?php echo $data_father_retrive['section_id']; ?>" <?php if ($father_id == $data_father_retrive['section_id']) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="section_title_ar" required=""
                                                           value="<?php echo $section_title_ar; ?>"
                                                           class="form-control"/>
                                                </div>
                                            </div>
                                                <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="section_title_en" required=""
                                                           value="<?php echo $section_title_en; ?>"
                                                           class="form-control"/>
                                                </div>
                                            </div>
                                                <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="hidden" name="section_icon" id="file_hidden_var"
                                                           value="<?php echo $section_icon; ?>"/>
                                                    <input type="hidden" name="file_del" id="file_del_var" value="0"/>
                                                    <?php
                                                    if ($section_icon != "") {
                                                        ?>
                                                        <div id="file_show_div">
                                                            <div><img src="<?php echo "$up_dir" . "$section_icon"; ?>"
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-plus"></i> <?php echo $lang_var_admin_87; ?>
                                    </div>
                                    <div class="tools">
                                        <a href="?wm_section=<?php echo $wm_section; ?>" class="close"></a>
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="?wm_section=<?php echo $wm_section; ?>&act=insert" method="post"
                                ...
                                <form name="multicheckfrm" id="multicheckfrm" method="post"
                                        ...
                                        if ($logged_allow_add_status == 1) {
                                            ...
                                            <div class="btn-group">
                                                <a href="?wm_section=<?php echo $wm_section; ?>&act=new"><span
                                                        ...
                                                        class="btn green">
									<?php echo $lang_var_admin_87; ?> <i class="fa fa-plus"></i>
									</span></a>
                                            </div>
                                            <?php
                                        }
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        $sql_retrive = mysql_query("SELECT * FROM " . $prefix .
                                            "_sections where wm_section_id='$wm_section'  and father_id=0 order by row_no, section_id");
                                        ...
                                        if ($page_records_count == 0) {
                                            ...
                                            while ($data_retrive = mysql_fetch_array($sql_retrive)) {
                                                if ($data_retrive['section_status'] == 1) {
                                                ...
                                                $section_icon = "";
                                                if ($data_retrive['section_icon'] != "") {
                                                    $section_icon = "<div class='pull-left'><img src='$up_dir" . "$data_retrive[section_icon]' style='width:25px;height:15px;margin:5px'></div>";
                                                }
                                                ...
                                                <tr class="odd gradeX">
                                                    <td>
                                                        <input type="checkbox" name="multichkbx[]" class="checkboxes"
                                                               value="<?php echo
                                                               $data_retrive['section_id']; ?>"/>
                                                    </td>
                                                    <td><input type="text"
                                                               name="row_no<?php echo $data_retrive['section_id'] ?>"
                                                               style="width: 30px;text-align: center;font-size: 11px;"
                                                               value="<?php echo $data_retrive['row_no'] ?>"> &nbsp;
                                                        <small>
                                                            <strong><?php echo $section_icon . stripslashes($data_retrive['section_title_' . $lang]); ?></strong>
                                                        </small>
                                                    </td>
                                                    ...
                                                    if ($logged_allow_edit_status == 1) {
                                                        ...
                                                        <td style="text-align: center;"><a
                                                                href="?wm_section=<?php echo $wm_section; ?>&id=<?php echo $data_retrive['section_id']; ?>&act=update"
...
// ---- sub sections
                                                $sql_sub_retrive = mysql_query("SELECT * FROM " . $prefix .
                                                    "_sections where wm_section_id='$wm_section' and father_id='$data_retrive[section_id]' order by row_no, section_id");
                                                while ($data_sub_retrive = mysql_fetch_array($sql_sub_retrive)) {
                                                    if ($data_sub_retrive['section_status'] == 1) {
                                                        $active_icn = "<span class='label label-sm label-info'><i class='fa fa-check'></i></span>";
                                                    } else {
                                                        $active_icn = "<span class='label label-default'><i class='fa fa-times'></i></span>";
                                                    }
                                                    $section_icon = "";
                                                    if ($data_sub_retrive['section_icon'] != "") {
                                                        $section_icon = "<div class='pull-right'><img src='$up_dir" . "$data_sub_retrive[section_icon]' style='width:25px;height:20px;margin:5px'></div>";
                                                    }


                                                    $sql_topics_count = mysql_query("SELECT * FROM " . $prefix . "_topics where wm_section_id='$wm_section' and  ( cat_id='$data_sub_retrive[section_id]' OR cat_id in (SELECT section_id FROM " . $prefix . "_sections where wm_section_id='$wm_section' and father_id='$data_sub_retrive[section_id]') )");
                                                    $records_topics_count = mysql_num_rows($sql_topics_count);
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        if ($logged_allow_edit_status == 1) {
                                                            ?>
                                                            <td style="text-align: center;"><a
                                                                    href="?wm_section=<?php echo $wm_section; ?>&id=<?php echo $data_sub_retrive['section_id']; ?>&act=update"
                                                                    class="btn btn-sm default"> <?php echo $lang_var_admin_6; ?>
                                                                    <i
                                                                        class="fa fa-edit"></i></a></td>
                                                            <?php
