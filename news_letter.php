...
//--------
    ...
    $id = @$_GET['id'];
    $nl_name = mysql_real_escape_string(@$_POST['nl_name']);
    $nl_phone = mysql_real_escape_string(@$_POST['nl_phone']);
    $nl_email = mysql_real_escape_string(@$_POST['nl_email']);
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="page-title"><?php echo $lang_var_admin_282; ?></h3>
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="#"><?php echo $lang_var_admin_282; ?></a>
                            </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        //   ----------- PAGE START
                        if ($act == "saveupdate" && $nl_email != "" && $id != "") {
                            $sql_update = mysql_query("UPDATE " . $prefix . "_newsletter SET nl_name='$nl_name',nl_phone='$nl_phone',nl_email='$nl_email' WHERE nl_id='$id'") or
                            die(mysql_error());

                        }
                        if ($act == "update") {
                            $sql_modify = mysql_query("SELECT * FROM " . $prefix .
                                "_newsletter  WHERE nl_id ='$id' ");
                            $data_modify = mysql_fetch_array($sql_modify);
                            $nl_name = stripcslashes($data_modify['nl_name']);
                            $nl_phone = stripcslashes($data_modify['nl_phone']);
                            $nl_email = stripcslashes($data_modify['nl_email']);
                            ?>
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-edit"></i> <?php echo $lang_var_admin_285; ?>
                                    </div>
                                    <div class="tools">
                                    ...
                                    <form action="?id=<?php echo $id; ?>&act=saveupdate" id="form_site_sections_new"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label
                                                    class="control-label col-md-3"><?php echo $lang_var_admin_283; ?> </label>

                                                <div class="col-md-4">
                                                    <input type="text" name="nl_name" value="<?php echo $nl_name; ?>"
                                                           class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="nl_phone" value="<?php echo $nl_phone; ?>"
                                                           class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="email" name="nl_email" value="<?php echo $nl_email; ?>"
                            ...
                            @ require_once("template/news_letter_view.php");
                        }
                        ?>
            ...
            var handleRecords = function () {
                ...
                grid.init({
                    ...
                    dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "sAjaxSource": "template/news_letter_view_ajax.php?lang=<?php echo $lang; ?>&var_admin_6=<?php echo $lang_var_admin_6; ?>&var_admin_25=<?php echo $lang_var_admin_25; ?>&logged_allow_edit_status=<?php echo $logged_allow_edit_status; ?>", // ajax source
