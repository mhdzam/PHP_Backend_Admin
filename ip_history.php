            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="page-title"><?php echo $lang_var_admin_429; ?></h3>
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="#"><?php echo $lang_var_admin_429; ?></a>
                            </li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        @ require_once("template/ip_history_view.php");
                        ?>
                    </div>
                </div>
                <!-- END PAGE CONTENT-->
            ...
            var handleRecords = function () {
                ...
                grid.init({
                    ...
                    dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "sAjaxSource": "template/ip_history_view_ajax.php?lang=<?php echo $lang; ?>&var_admin_6=<?php echo $lang_var_admin_6; ?>&var_admin_25=<?php echo $lang_var_admin_25; ?>", // ajax source
