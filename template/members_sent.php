...
<table class="table table-striped table-bordered table-advance table-hover">
    <thead>
    <tr>
        <th><?php echo $lang_var_admin_451; ?></th>
    ...
    <tbody>
    <?php
    $sql_notices = mysql_query("SELECT * FROM " . $prefix . "_webmail where (member_id ='$id'  || wm_from = '$member_email') and cat_id = 0 order by wm_date desc");
