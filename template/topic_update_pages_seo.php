...
if ($seoact_act == "save" && $seo_title_ar != "" && $id != "") {
    ...
    $sql_update = mysql_query("UPDATE " . $prefix . "_topics SET seo_title_ar='$seo_title_ar',seo_title_en='$seo_title_en',seo_details_ar='$seo_details_ar',seo_details_en='$seo_details_en',seo_keywords_ar='$seo_keywords_ar',seo_keywords_en='$seo_keywords_en'  WHERE topic_id='$id'") or
    die(mysql_error());
...
$sql_modify_seo = mysql_query("SELECT * FROM " . $prefix . "_topics  WHERE wm_section_id ='$wm_section' AND topic_id='$id' ");
    ...
    <form action="?wm_section=<?php echo $wm_section; ?>&id=<?php echo $id; ?>&act=update&seoact=save#portlet_tab4"
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                <label class="control-label col-md-2"><?php echo $lang_var_admin_192; ?>  <?php echo $ar_lang_icon; ?></label>

                <div class="col-md-9" dir="rtl">
                    <input type="text" maxlength="65" name="seo_title_ar" class="form-control" value="<?php echo $seo_title_ar; ?>"/>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-md-2"><?php echo $lang_var_admin_193; ?>  <?php echo $ar_lang_icon; ?></label>
            ...
            <div class="form-group">
                <label class="control-label col-md-2"><?php echo $lang_var_admin_194; ?>  <?php echo $ar_lang_icon; ?></label>
            ...
            <div class="form-group">
                <label class="control-label col-md-2"><?php echo $lang_var_admin_192; ?>  <?php echo $en_lang_icon; ?></label>
            ...
            <div class="form-group">
                <label class="control-label col-md-2"><?php echo $lang_var_admin_193; ?>  <?php echo $en_lang_icon; ?></label>
            ...
            <div class="form-group">
                <label class="control-label col-md-2"><?php echo $lang_var_admin_194; ?>  <?php echo $en_lang_icon; ?></label>
