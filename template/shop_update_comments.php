...
$sql_modify = mysql_query("SELECT * FROM " . $prefix . "_shop_comments  WHERE comment_id='$id' ");
...
$item_id = stripcslashes($data_modify['item_id']);
...
$sql_section = mysql_query("SELECT * FROM " . $prefix . "_shop_items where item_id ='$item_id'");
        ...
        <form action="?id=<?php echo $id; ?>&act=saveupdate" method="post" class="form-horizontal"
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <a href="shop_items.php?id=<?php echo $item_id; ?>&act=update"><?php echo $topic_section_is; ?></a>
                    </div>
                </div>
