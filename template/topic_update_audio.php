        ...
        <div class=" portlet-tabs">
            ...
            <div class="tab-content">
				...
				<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2"><?php echo $lang_var_admin_119; ?> <span
                                            class="required">*</span></label>

                                    <div class="col-md-9">

                                        <div class="input-group input-medium">
                                            <input name="topic_audio_file" readonly type="text" id="topic_audio_file"
                                                   dir="ltr" value="<?php echo $topic_audio_file; ?>"
                                                   class="form-control input-large" required="">
                
				<span class="input-group-btn">
					<a href="javascript:;"
                       onclick="moxman.browse({fields: 'topic_audio_file', extensions:'mp3,wav', no_host: true});"
                       class="btn default"><?php echo $lang_var_admin_206; ?></a>
				</span>
                <span class="input-group-btn">
                <a href="javascript:;" onclick="document.getElementById('topic_audio_file').value=''"
                   class="btn default">&nbsp;<i class="fa fa-times"></i>&nbsp;</a>
                </span>
                                        </div>
                                        <span class="help-block">e.g: .mp3, .wav</span>
                                    </div>
                                </div>
