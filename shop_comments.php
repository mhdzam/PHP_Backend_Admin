            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="page-title"><?php echo $lang_var_admin_299; ?></h3>
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="#"><?php echo $lang_var_admin_299; ?></a>
                            </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if ($act == "saveupdate" && $comment != "" && $id != "") {
                            ...
                            $sql_update = mysql_query("UPDATE " . $prefix . "_shop_comments SET name='$name',email='$email',comment='$comment',edit_by='$pd_admin_user_id',edit_date=now(),edit_from='$pd_admin_ip' WHERE comment_id='$id'") or
                            die(mysql_error());
                        ...
                        if ($act == "update") {
                            ...
                            @ require_once("template/shop_update_comments.php");

                        } else {

                            @ require_once("template/shop_view_comments.php");
            ...
            var handleRecords = function () {
                ...
                grid.init({
                    ...
                    dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "sAjaxSource": "template/shop_view_comments_ajax.php?lang=<?php echo $lang; ?>&var_admin_6=<?php echo $lang_var_admin_6; ?>&var_admin_25=<?php echo $lang_var_admin_25; ?>&logged_allow_edit_status=<?php echo $logged_allow_edit_status; ?>", // ajax source
