...
$invoice_price = stripcslashes($data_modify['invoice_paid']);
...
$invoice_pay_type = stripcslashes($data_modify['invoice_pay_type']);
...
?>
    ...
    <div class="modelTitle">
        <h4><i class="fa fa-edit"></i> <?php echo $lang_var_admin_470; ?> </h4>
    </div>
    <br>

    <form
        action="members.php?id=<?php echo $member_id; ?>&act=update&invoice_id=<?php echo $invoice_id; ?>&invoic2eact=save<?php echo $sve_in; ?>"
        method="post"
        ...
        ?>
        <div class="modelTitle">
            <h4><i class="fa fa-edit"></i> <?php echo $lang_var_admin_469; ?> </h4>
        </div>
    <br>
        <form
            action="members.php?id=<?php echo $member_id; ?>&act=update&invoic2eact=insert<?php echo $sve_in; ?>"
            method="post"
            class="form-horizontal" enctype="multipart/form-data">
            <?php
            }
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="invoice_title" required="" value="<?php echo $invoice_title; ?>"
                               class="form-control"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="invoice_price" required="" value="<?php echo $invoice_price; ?>"
                               class="form-control"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label
                        class="control-label col-md-3"><?php echo $lang_var_admin_477; ?> <span
                            class="required">*</span></label>

                    <div class="col-md-8">
                        <div class="radio-list">
                            <label style="display: inline-block;"><input type="radio" name="invoice_pay_type"
                                                                         value="0" <?php if ($invoice_pay_type == 0) {
                                    echo "checked";
                                } ?>/><?php echo $lang_var_admin_478; ?> </label> &nbsp; &nbsp;
                            <label style="display: inline-block;"><input type="radio" name="invoice_pay_type"
                                                                         value="1" <?php if ($invoice_pay_type == 1) {
                                    echo "checked";
                                } ?>/><?php echo $lang_var_admin_479; ?> </label> &nbsp; &nbsp;
                            <label style="display: inline-block;"><input type="radio" name="invoice_pay_type"
                                                                         value="2" <?php if ($invoice_pay_type == 2) {
                                    echo "checked";
                                } ?>/><?php echo $lang_var_admin_480; ?> </label> &nbsp; &nbsp;
                            <label style="display: inline-block;"><input type="radio" name="invoice_pay_type"
                                                                         value="3" <?php if ($invoice_pay_type == 3) {
                                    echo "checked";
                                } ?>/><?php echo $lang_var_admin_481; ?> </label>
