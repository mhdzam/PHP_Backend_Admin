...
?>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="page-title"><?php echo $lang_var_admin_296; ?></h3>
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="#"><?php echo $lang_var_admin_296; ?></a>
                            </li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if ($clicked_btn == "b_saveorder") {
                            $sql_delete_who = mysql_query("SELECT * FROM " . $prefix . "_shop_sections");
                            while ($data_delete_who = @mysql_fetch_array($sql_delete_who)) {
                                $inm = "row_no" . "$data_delete_who[section_id]";
                                $row_no = @$_POST[$inm];
                                $sql_sveorder = mysql_query("UPDATE " . $prefix . "_shop_sections SET row_no='$row_no' WHERE section_id='$data_delete_who[section_id]'") or die (mysql_error());
                                if ($sql_sveorder) {
                                    $actin_done = 1;
                                }
                            }
                        ...
                        if ($multichkbx != "") {
                            ...
                            if ($clicked_btn == "b_active") {
                                $sql_active = mysql_query("UPDATE " . $prefix .
                                    "_shop_sections SET section_status=1 WHERE section_id in ($multichkbx)") or die(mysql_error
                                ());
                                if ($sql_active) {
                                    $actin_done = 1;
                                }
                                ...
                                $sql_block = mysql_query("UPDATE " . $prefix .
                                    "_shop_sections SET section_status=0 WHERE section_id in ($multichkbx)") or die(mysql_error
                                ());
                                if ($sql_block) {
                                    $actin_done = 1;
                                }
                                ...
                                $sql_delete_who = mysql_query("SELECT * FROM " . $prefix .
                                    "_shop_sections where section_id  in ($multichkbx)");
                                while ($data_delete_who = @mysql_fetch_array($sql_delete_who)) {
                        ...
                        if ($act == "insert") {
                            ...
                            $r = "select max(row_no)  from " . $prefix . "_shop_sections where father_id='$father_id'";
                            $sqlr = mysql_query($r);
                            ...
                            $sql_insert_new = mysql_query("INSERT INTO " . $prefix . "_shop_sections (
  section_id,
  section_title_ar,
  section_title_en,
  father_id,
  ...
  edit_date,
  edit_from,
  row_no) VALUES ('$next_section_id','$section_title_ar','$section_title_en','$father_id','$section_icon','1','$pd_admin_user_id',now(),'$pd_admin_ip','$row')");
                            ...
                            <i class='fa fa-sitemap'></i>
                                ...
                                $note_url = mysql_real_escape_string("shop_sections.php?id=$next_section_id&act=update");
                        ...
                        if ($act == "saveupdate" && $id != "") {
                            ...
                            $sql_update = mysql_query("UPDATE " . $prefix . "_shop_sections SET section_title_ar='$section_title_ar',section_title_en='$section_title_en',father_id='$father_id',section_icon='$section_icon',edit_by='$pd_admin_user_id',edit_date=now(),edit_from='$pd_admin_ip' WHERE section_id='$id'") or
                            die(mysql_error());
                        ...
                        if ($act == "update") {
                            $sql_modify = mysql_query("SELECT * FROM " . $prefix .
                                "_shop_sections  WHERE section_id ='$id' ");
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control" name="father_id" class="select2me">
                                                            <option value="0"><?php echo $lang_var_admin_91; ?>...
                                                            </option>
                                                            <?php
                                                            $sql_father_retrive = mysql_query("SELECT * FROM " . $prefix . "_shop_sections where father_id='0' and section_id !='$id' order by row_no, section_id");
                                ...
                                <form name="multicheckfrm" id="multicheckfrm" method="post" action="?">
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        $sql_retrive = mysql_query("SELECT * FROM " . $prefix .
                                            "_shop_sections where father_id=0 order by row_no, section_id");
                                        ...
                                        if ($page_records_count == 0) {
                                            ...
                                            while ($data_retrive = mysql_fetch_array($sql_retrive)) {
                                                ...
                                                $sql_topics_count = mysql_query("SELECT * FROM " . $prefix . "_topics where  ( cat_id='$data_retrive[section_id]' OR cat_id in (SELECT section_id FROM " . $prefix . "_shop_sections where father_id='$data_retrive[section_id]') )");
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    if ($logged_allow_edit_status == 1) {
                                                        ...
                                                        <td style="text-align: center;"><a
                                                                href="?id=<?php echo $data_retrive['section_id']; ?>&act=update"
...
// ---- sub sections
                                                $sql_sub_retrive = mysql_query("SELECT * FROM " . $prefix .
                                                    "_shop_sections where father_id='$data_retrive[section_id]' order by row_no, section_id");
                                                while ($data_sub_retrive = mysql_fetch_array($sql_sub_retrive)) {
                                                    ...
                                                    $sql_topics_count = mysql_query("SELECT * FROM " . $prefix . "_topics where ( cat_id='$data_sub_retrive[section_id]' OR cat_id in (SELECT section_id FROM " . $prefix . "_shop_sections where father_id='$data_sub_retrive[section_id]') )");
                                                    $records_topics_count = mysql_num_rows($sql_topics_count);
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        if ($logged_allow_edit_status == 1) {
                                                            ?>
                                                            <td style="text-align: center;"><a
                                                                    href="?id=<?php echo $data_sub_retrive['section_id']; ?>&act=update"
                                                                    class="btn btn-sm default"> <?php echo $lang_var_admin_6; ?>
                                                                    <i
                                                                        class="fa fa-edit"></i></a></td>
                                                            <?php
