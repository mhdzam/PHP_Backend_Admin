            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="page-title"><?php echo $lang_var_admin_379; ?></h3>
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="#"><?php echo $lang_var_admin_269; ?></a>
                            </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @ require_once("template/notifications_view.php");
            ...
            var handleRecords = function () {
                ...
                grid.init({
                    ...
                    dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "sAjaxSource": "template/notifications_view_ajax.php?lang=<?php echo $lang; ?>&var_admin_6=<?php echo $lang_var_admin_6; ?>&var_admin_25=<?php echo $lang_var_admin_25; ?>", // ajax source
